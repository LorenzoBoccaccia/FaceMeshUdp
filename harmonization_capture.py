...
# 8 prompts to capture
PROMPTS = [
    # Head movements (4)
    {"name": "head-left", "instruction": "Turn your HEAD to the LEFT", "type": "head"},
    {"name": "head-right", "instruction": "Turn your HEAD to the RIGHT", "type": "head"},
    {"name": "head-up", "instruction": "Tilt your HEAD UP", "type": "head"},
    {"name": "head-down", "instruction": "Tilt your HEAD DOWN", "type": "head"},
    # Eye movements (4)
    {"name": "eye-left", "instruction": "Look with your EYES to the LEFT (keep head still)", "type": "eye"},
    {"name": "eye-right", "instruction": "Look with your EYES to the RIGHT (keep head still)", "type": "eye"},
    {"name": "eye-up", "instruction": "Look with your EYES UP (keep head still)", "type": "eye"},
    {"name": "eye-down", "instruction": "Look with your EYES DOWN (keep head still)", "type": "eye"},
]
...
class HarmonizationCapture:
    ...
    def draw_ui(self, frame, prompt: Dict[str, Any], progress: int, total: int):
        ...
        draw_text_with_background(frame, instruction, (30, 100), font_scale=1.2, 
        ...
        cv2.putText(frame, type_text, (30, 160), cv2.FONT_HERSHEY_SIMPLEX, 0.8, color, 2, cv2.LINE_AA)
        
        # Click instruction
        click_text = "CLICK anywhere or press SPACE to capture"
        cv2.putText(frame, click_text, (30, 190), cv2.FONT_HERSHEY_SIMPLEX, 0.7, WHITE, 1, cv2.LINE_AA)
